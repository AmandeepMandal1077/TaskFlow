      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {filteredBoards.length === 0 && debouncedSearch.trim() !== "" ? (
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              ...
              <div key={board.id} className="group">
                <Link href={`/board/${board.id}`}>
                  <Card className="h-36 gap-0 overflow-hidden rounded-xl border-neutral-700 bg-neutral-800 p-0 transition-all duration-200 hover:-translate-y-0.5 hover:border-neutral-500 hover:shadow-md">
                    <CardHeader
                      className={`h-[75%] border-b border-neutral-700 p-0 ${board.color || "bg-neutral-600"
                        }`}
                    />
            ...
            <Card className="h-36 overflow-hidden rounded-xl border border-dashed border-neutral-600 bg-neutral-800/50 p-0 transition-all duration-200 hover:border-neutral-500 hover:bg-neutral-800 flex flex-col justify-center relative">
              {isCreating ? (
